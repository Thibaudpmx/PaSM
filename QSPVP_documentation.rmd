...
[QSPVP](https://github.com/Thibaudpmx/QSPVP/) is a R package allowing to accelerate the generation of plausible VPs by replacing time-consuming ODE solving steps with simple mononotic parameter value comparisons. This package is used in two steps:
...
If you have any question, suggestion or bug reporting, please send it by email to thibaud.derippe@gmail.com, or  [create an issue on GitHub](https://github.com/Thibaudpmx/QSPVP/issues)
...
The easiest way to learn how to use the algorithm 2 is by looking at the "hide and seek" code used to produce one of the article figure: https://github.com/Thibaudpmx/QSPVP/blob/main/article_resources/figures_source_code/figure_5.R 
